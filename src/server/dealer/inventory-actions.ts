...
function parseInventoryForm(formData: FormData) {
  return inventoryFormSchema.safeParse({
    ...
    widthInches: formData.get("widthInches") || undefined,
    heightInches: formData.get("heightInches") || undefined,
    dryWeightLbs: formData.get("dryWeightLbs") || undefined,
    gvwrLbs: formData.get("gvwrLbs") || undefined,
    hitchWeightLbs: formData.get("hitchWeightLbs") || undefined,
    sleeps: formData.get("sleeps") || undefined,
    slideCount: formData.get("slideCount") || undefined,
    bedConfiguration: formData.get("bedConfiguration") || undefined,
    ...
    interior: formData.get("interior") || undefined,
...
export async function createInventory(
  ...
  const [rv] = await db
    ...
    .values({
      ...
      widthInches: d.widthInches ? Math.round(d.widthInches) : null,
      heightInches: d.heightInches ? Math.round(d.heightInches) : null,
      dryWeightLbs: d.dryWeightLbs ? Math.round(d.dryWeightLbs) : null,
      gvwrLbs: d.gvwrLbs ? Math.round(d.gvwrLbs) : null,
      hitchWeightLbs: d.hitchWeightLbs ? Math.round(d.hitchWeightLbs) : null,
      sleeps: d.sleeps,
