...
export const searchFiltersSchema = z.object({
  ...
  priceMin: z.coerce.number().nonnegative().max(10_000_000).optional(),
  priceMax: z.coerce.number().nonnegative().max(10_000_000).optional(),
  lengthMinFeet: z.coerce.number().nonnegative().max(100).optional(),
  lengthMaxFeet: z.coerce.number().nonnegative().max(100).optional(),
  sleepsMin: z.coerce.number().int().nonnegative().max(50).optional(),
  dryWeightMaxLbs: z.coerce.number().nonnegative().max(100_000).optional(),
